...
public class RabbitConfig {
	...
	public Queue topicQueue1() {
		return new Queue(Constant.TOPIC_QUEUE1);
	}

	@Bean
	public Queue topicQueue2() {
		return new Queue(Constant.TOPIC_QUEUE2);
	}
	...
	public Queue fanoutQueue1() {
		return new Queue(Constant.FANOUT_QUEUE1);
	}

	@Bean
	public Queue fanoutQueue2() {
		return new Queue(Constant.FANOUT_QUEUE2);
	}
	...
	public Queue directQueue1() {
		return new Queue(Constant.DIRECT_QUEUE1);
	}
